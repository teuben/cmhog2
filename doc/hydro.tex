...
Once the halo is added (parameters have not been implemented), this
...
system in the FITS file, as defined by the CRVAL/CRPIX/CDELT keywords
...
- define pattern speed, currently it's inherited from 'rl' in 'pgen' (see cmhogin)
   $pgen rl=6.0 $

- pot1 is not working yet, so only axisymetric potentials work
...
\begin{verbatim}
ratio of gnuy to intel compiler on a Piv/2.2
