...
{\tt cmhog} uses a file {\tt configure.in}\footnote{this is an older version of autoconf,
newer versions will use {\tt configure.ac}}.  The program {\tt autoconf} produces a new
...
you run the risk of loosing your work on a subsequent.
